...
// PG_MIXER_CONFIG
    ...
    { "rpm_limit_rpm_filter_cutoff",    VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 1000 },        PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limit_rpm_filter_cutoff) },
    { "rpm_limit_thr_scale_cutoff",    VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 1000 },        PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limit_thr_scale_cutoff) },
    { "rpm_limit_d_term_cutoff",    VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 1000 },        PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limit_d_term_cutoff) },
#endif
