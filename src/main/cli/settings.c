...
// PG_FF_AUTOTUNE_CONFIG
    ...
    { "ff_autotune_f_adj_roll",         VAR_INT8   | MASTER_VALUE, .config.minmax = { -100, 100 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, f_adj_roll) },
    { "ff_autotune_f_adj_pitch",        VAR_INT8   | MASTER_VALUE, .config.minmax = { -100, 100 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, f_adj_pitch) },
    ...
    { "ff_autotune_p_adj_roll",         VAR_INT8   | MASTER_VALUE, .config.minmax = { -20, 20 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, p_adj_roll) },
    { "ff_autotune_p_adj_pitch",        VAR_INT8   | MASTER_VALUE, .config.minmax = { -20, 20 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, p_adj_pitch) },
    { "ff_autotune_d_adj_roll",         VAR_INT8   | MASTER_VALUE, .config.minmax = { -10, 10 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, d_adj_roll) },
    { "ff_autotune_d_adj_pitch",        VAR_INT8   | MASTER_VALUE, .config.minmax = { -10, 10 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, d_adj_pitch) },
    // Phase 2b: Noise reduction (filter adjustment + P/D scale-down)
    { "ff_autotune_noise_floor",        VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 100, 2000 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, noise_floor) },
    ...
    { "ff_autotune_gyro_noise_threshold", VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 100, 2000 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, gyro_noise_threshold) },
    { "ff_autotune_lpf2_step",          VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 10, 100 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, lpf2_step) },
    { "ff_autotune_lpf2_min",           VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 50, 500 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, lpf2_min) },
    { "ff_autotune_dterm_lpf2_step",    VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 5, 50 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, dterm_lpf2_step) },
    { "ff_autotune_dterm_lpf2_min",     VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 50, 300 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, dterm_lpf2_min) },
    { "ff_autotune_gain_scale_step",    VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, 20 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, gain_scale_step) },
    { "ff_autotune_gain_scale_min",     VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 20, 100 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, gain_scale_min) },
    { "ff_autotune_lpf2_adj",           VAR_INT16  | MASTER_VALUE, .config.minmax = { -500, 500 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, lpf2_adj) },
    { "ff_autotune_dterm_lpf2_adj",     VAR_INT16  | MASTER_VALUE, .config.minmax = { -200, 200 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, dterm_lpf2_adj) },
    { "ff_autotune_gain_scale_roll",    VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 20, 100 }, PG_FF_AUTOTUNE_CONFIG, offsetof(ffAutotuneConfig_t, gain_scale_roll) },
